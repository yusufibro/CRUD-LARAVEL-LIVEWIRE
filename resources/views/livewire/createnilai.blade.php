    ...
    <span class="hidden sm:inline-block sm:align-middle sm:h-screen"></span>&#8203;
        ...
        <form action="">
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div>
                        <div class="mb-2">
                            <input wire:model="nilaiId" type="hidden" name="id_nilai" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="input ID">
                        </div>
                        <div class="mb-2">
                            <label for="id_nilai" class="block">Id Nilai</label>
                            <input wire:model="id_nilai" type="text" name="id_nilai" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="input ID">
                            @error('id_nilai') <h2 class="text-red-500">{{ ($message) }}</h2> @enderror
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="id_matakuliah" class="block">Id Matakuliah</label>
                            <input wire:model="id_matakuliah" type="text" name="id_matakuliah" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="input ID">
                            @error('id_matakuliah') <h2 class="text-red-500">{{ ($message) }}</h2> @enderror
                        </div>
                        <div class="mb-2">
                            <label for="nilai" class="block">Nilai</label>
                            <input wire:model="nilai" type="text" name="nilai" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Input Nama">
                            @error('nilai') <h2 class="text-red-500">{{ ($message) }}</h2> @enderror
                        </div>
                    </div>
            </div>
